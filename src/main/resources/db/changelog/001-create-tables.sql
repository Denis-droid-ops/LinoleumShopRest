...
--rollback DROP TABLE fragment;

--changeset dkuznetsov:10
...
--rollback DROP TABLE linoleum;

--changeset dkuznetsov:11
CREATE TABLE orders
(
    id     SERIAL PRIMARY KEY,
...
--rollback DROP TABLE fragment_order;

--changeset dkuznetsov:15
CREATE INDEX order_id_idx ON fragment_order(order_id);
--rollback DROP TABLE fragment_order;

--changeset dkuznetsov:16
CREATE TABLE roll
(
    id     SERIAL PRIMARY KEY,
...
--rollback DROP TABLE roll;

--changeset dkuznetsov:17
